...
<script type="text/javascript">
	...
	function regOpinonAmt(){
		var url = "/portfolio/regOpinonAmt/ajax";
	...
	<div class="row">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
                    ...
                    <div class="dropdown-header" style="font-size: 15px; padding: 8px 0px 8px 0px; display: -webkit-inline-box;">
                    	매수 의견 : <span style="color: black;"><c:out value="${resultData.INVEST_OPINION}"/></span>
                    	<div class="dropdown no-arrow" style="right: -65px;">
			                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			                    <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
			                </a>
			                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
			                    <div class="dropdown-header" id="opiAmtDiv" style="font-size: 11px;">
			                    	- 투자의견 금액 등록 -
			                    	<button class="btn btn-outline-primary" style="height: 29px; font-size: 11px; width: 50px; margin-left: 215px;" id="btn_DEPOSIT_AMOUNT" onclick="regOpinonAmt(); return false;">
					                    	등록
					                </button>
			                    </div>
			                    <div class="dropdown-divider"></div>
			                    ...
			                    <form name="opinionForm">
				                    <div class="dropdown-item" style="padding: 10px 10px 10px 10px; text-align: right;">
					                    매수 :
					                    <input type="text" name="OPINION_AMOUNT1" id="OPINION_AMOUNT1" style="width : 120px;" value="" title="예수금" placeholder="예수금">
				                    </div>
				                    <div class="dropdown-divider"></div>
				                    <div class="dropdown-item" style="padding: 10px 10px 10px 10px;  text-align: right;">
					                    비중확대 : 
					                    <input type="text" name="OPINION_AMOUNT2" id="OPINION_AMOUNT2" style="width : 120px;" value="" title="예수금" placeholder="예수금"> 
				                    </div>
				                    <div class="dropdown-divider"></div>
				                    <div class="dropdown-item" style="padding: 10px 10px 10px 10px;  text-align: right;">
					                    중립 : 
					                    <input type="text" name="OPINION_AMOUNT3" id="OPINION_AMOUNT3" style="width : 120px;" value="" title="예수금" placeholder="예수금"> 
				                    </div>
				                    <div class="dropdown-divider"></div>
				                    <div class="dropdown-item" style="padding: 10px 10px 10px 10px;  text-align: right;">
					                    비중축소 : 
					                    <input type="text" name="OPINION_AMOUNT4" id="OPINION_AMOUNT4" style="width : 120px;" value="" title="예수금" placeholder="예수금"> 
				                    </div>
				                    <div class="dropdown-divider"></div>
				                    <div class="dropdown-item" style="padding: 10px 10px 10px 10px;  text-align: right;">
					                    매도 : 
					                    <input type="text" name="OPINION_AMOUNT5" id="OPINION_AMOUNT5" style="width : 120px;" value="" title="예수금" placeholder="예수금"> 
				                    </div>
				                    <div class="dropdown-divider"></div>
				                </form>
			                    </div>
	    ...
	    <div class="col-xl-4 col-lg-5">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<textarea  rows="20" cols="85" style="    font-size: 10px;"><c:out value="${resultData.MEMO }"/></textarea>
				</div>
			</div>
		</div>
	</div>
