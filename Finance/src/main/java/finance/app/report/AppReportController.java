...
public class AppReportController extends DefaultController{
	...
	public ResponseEntity<Map<String, Object>> getPortAmount(HttpServletRequest request) throws Exception{ 
        ...
        // 파라미터 설정
        String parameters = "?fid_cond_mrkt_div_code=J&fid_input_iscd=005930&fid_input_date_1=20230401&fid_input_date_2=20230501&fid_period_div_code=D&fid_org_adj_prc=0";
